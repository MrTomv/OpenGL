...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("res/shader02/Lighting_maps.vs", "res/shader02/Lighting_maps.fs");
    Shader lightCubeShader("res/shader02/basic_lighting_cube.vs", "res/shader02/basic_lighting_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
       ...
       // lightPos.x = 1.0f + sin(glfwGetTime()) * 2.0f;
        ...
        //glm::vec3 ambientColor = diffuseColor; // 很低的影响
