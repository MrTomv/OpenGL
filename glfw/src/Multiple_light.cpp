...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("res/shader02/Multiple_light.vs", "res/shader02/Multiple_light.fs");
    Shader lightCubeShader("res/shader02/Light_cube_caster.vs", "res/shader02/Light_cube_caster.fs");
