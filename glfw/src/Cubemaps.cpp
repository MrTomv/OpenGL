...
int main()
{
    ...
    Shader ourShader("res/Shader04/Cubemaps2.vs", "res/Shader04/Cubemaps2.fs");
    Shader skybox("res/Shader04/Cubemaps.vs", "res/Shader04/Cubemaps.fs");
    unsigned int cubeMap = loadTexture("res/texture/container2.png");
    unsigned int cubemapsTexture = loadCubemap(faces);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindVertexArray(skyVAO);
        glActiveTexture(GL_TEXTURE0);
        glBindTexture(GL_TEXTURE_CUBE_MAP, cubemapsTexture);
        glDrawArrays(GL_TRIANGLES, 0, 36);
        glBindVertexArray(0);
