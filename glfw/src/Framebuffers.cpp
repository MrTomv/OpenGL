...
int main()
{
    ...
    Shader ourShader("res/Shader04/FrameBuffers.vs", "res/Shader04/FrameBuffers.fs");
    Shader screenShader("res/Shader04/FrameBuffer_win.vs", "res/Shader04/FrameBuffer_win.fs");
