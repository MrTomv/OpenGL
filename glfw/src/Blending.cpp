...
int main()
{
    ...
    glBindBuffer(GL_ARRAY_BUFFER, glassVAO);
    ...
    Shader ourShader("res/Shader04/Blending.vs", "res/Shader04/Blending.fs");
    unsigned int cubeMap = loadTexture("res/texture/marble.jpg");
    unsigned int planeMap = loadTexture("res/texture/metal.png");
    unsigned int glassMap = loadTexture("res/texture/window.png");
